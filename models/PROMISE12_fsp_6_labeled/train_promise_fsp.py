...
parser.add_argument('--labeled-id-path', type=str, default='/home/user/promise12/6labeled_2.txt')
parser.add_argument('--unlabeled-id-path', type=str, default='/home/user/promise12/6unlabeled_2.txt')
