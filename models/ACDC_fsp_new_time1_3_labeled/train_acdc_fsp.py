...
parser.add_argument('--labeled-id-path', type=str, default='/home/user/ACDC/3_labeled_3.txt')
parser.add_argument('--unlabeled-id-path', type=str, default='/home/user/ACDC/3_unlabeled_3.txt')

parser.add_argument('--exp', type=str, default=r'fsp_new_time1_RE3', help='experiment_name')
