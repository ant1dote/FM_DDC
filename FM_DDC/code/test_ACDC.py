...
parser.add_argument('--exp', type=str, default='FSP_3labeled', help='experiment_name')
...
def Inference(FLAGS):
    ...
    snapshot_path = '/home/user/Frequency_Matters_DDC_SSL_Skin_Lesion_Segmentation/model/ACDC_fsp_new_time1_RE2_3_labeled/unets_noa_best_model.pth'
    test_save_path = "/home/user/Frequency_Matters_DDC_SSL_Skin_Lesion_Segmentation/{}_predictions/".format(FLAGS.exp)
    if os.path.exists(test_save_path):
        shutil.rmtree(test_save_path)
    os.makedirs(test_save_path)
    net = net_factory(FLAGS,net_type=FLAGS.model, in_chns=1, class_num=FLAGS.num_classes)
