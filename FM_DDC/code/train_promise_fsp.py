...
parser.add_argument('--labeled-id-path', type=str, default='/home/user/promise12/6labeled_3.txt')
parser.add_argument('--unlabeled-id-path', type=str, default='/home/user/promise12/6unlabeled_3.txt')

parser.add_argument('--exp', type=str, default=r'fsp_RE3', help='experiment_name')
