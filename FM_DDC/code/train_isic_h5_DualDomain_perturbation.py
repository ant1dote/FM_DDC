...
from dataloaders.acdc import  Skin_DIFF_FSP, ISICDataset_DIFF
...
parser.add_argument('--labeled-id-path', type=str, default='/home/user/ISIC2017/1%_labeled_1.txt')
parser.add_argument('--unlabeled-id-path', type=str, default='/home/user/ISIC2017/1%_unlabeled_1.txt')
parser.add_argument('--config', type=str, default='/home/user/Frequency_Matters_DDC_SSL_Skin_Lesion_Segmentation/code/configs/isic.yaml')
parser.add_argument('--exp', type=str, default=r'FSP_ResUNets_RE1', help='experiment_name')
...
def self_train(args, snapshot_path):
    ...
    for _ in iterator:
        ...
        for i,((img_x, mask_x),
            ...
            pred_u_w_fp_a = model.subnet1(img_u_w, need_fp=True)
            pred_u_w_fp_b = model.subnet2(img_u_w, need_fp=True)
...
if __name__ == "__main__":
    ...
    shutil.copytree('/home/user/Frequency_Matters_DDC_SSL_Skin_Lesion_Segmentation/code', self_snapshot_path + '/code',shutil.ignore_patterns(['.git', '__pycache__']))
