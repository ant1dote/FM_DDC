...
from dataloaders.acdc import Skin_DIFF_FSP
...
def self_train(args ,pre_snapshot_path, snapshot_path):
    ...
    trainset_u = Skin_DIFF_FSP(args.dataset, args.root_path, 'train_u', 
                             args.patch_size[0], args.unlabeled_id_path)
    trainset_l = Skin_DIFF_FSP(args.dataset, args.root_path, 'train_l', 
                             args.patch_size[0],args.labeled_id_path, nsample=len(trainset_u.ids))
    
    db_val = Skin_DIFF_FSP(args.dataset, args.root_path, "val")
